...
- PROJECT_STRUCTURE.md 中的层级约束（Project Utility → Foundational Service → Business Service → Business Logic）强调 Interface/Entry 层只能做协议转换；本次需要新增的日志/变量 API 必须落在 Interface + Business Service 的协同，而非直接写在 Foundational 层。
