...
- 生成时间: 2025-10-24T06:56:35.999084+00:00
- 来源目录: `TreatyTraderorTreatyInvestor9D`
## Checklist.pdf
- 路径: `Checklist.pdf`
- 更新: 2025-10-24T06:05:41.123808+00:00

```
BI FORM V-NI-002-Rev 1
...
characters only.
The Consolidated General Application Form (CGAF) must be accomplished in two (2) ORIGINAL copies. The first copy shall be submitted
...
7.
6. All  foreign  documents  must  be  original  and  authenticated  by  the  Philippine  Foreign  Service  Post  (FSP),  which  has  jurisdiction over  the
...
6. Duly acknowledged Employment Contract, Secretary’s Certificate of Election, Appointment, Assignment, Secondment or Deployment
of applicant, or equivalent document indicating duration of employment, compensation and other benefits, and  scope of duties;
7. Board Resolution if the signatories of the letter of application and employment contract are other than those appearing in the Articles of
Incorporation and in the latest GIS;
8. BI Clearance Certificate; and
9. Original or certified true copy of Bureau of Quarantine Medical Clearance, if applicant is a national of any of the countries listed under
...
- 更新: 2025-10-24T06:05:39.288003+00:00
...
- 更新: 2025-10-24T06:05:41.704898+00:00

```
BI FORM V-NI-003-Rev 1
BI FORM V-NI-003-Rev 1
BI FORM V-NI-003-Rev 1
BI FORM V-NI-003-Rev 1
...
2. Duly accomplished CGAF for Non-Immigrant Visa;
2. Duly accomplished CGAF for Non-Immigrant Visa;
3. Photocopy of the applicant’s passport bio-page, visa implementation and latest admission with valid authorized stay;
3. Photocopy of the applicant’s passport bio-page, visa implementation and latest admission with valid authorized stay;
3. Photocopy of the applicant’s passport bio-page, visa implementation and latest admission with valid authorized stay;
3. Photocopy of the applicant’s passport bio-page, visa implementation and latest admission with valid authorized stay;
...
- 更新: 2025-10-24T06:05:39.020589+00:00
