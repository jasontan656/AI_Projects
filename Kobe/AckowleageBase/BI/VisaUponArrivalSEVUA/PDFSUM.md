...
- 生成时间: 2025-10-24T06:56:39.267243+00:00
- 来源目录: `VisaUponArrivalSEVUA`
## Checklist.pdf
- 路径: `Checklist.pdf`
- 更新: 2025-10-24T06:06:15.236930+00:00

```
BI FORM 2014-01-002 Rev 0
...
1.  Letter request addressed to the Commissioner from the guarantor or sponsoring organization containing
the following details of the nominee:
a.  Name as it appears in the passport;
b.  Place and date of birth, nationality as well as passport number, place and date of its  issuance
and validity;
c.  Residential address abroad and local address in the Philippines;
d.  Flight details;
e.  Nature and purpose of visit;
2.  Endorsement letter from the appropriate government agency, if applicable;
3.  Photocopy of applicant’s passport bio-page;
4.  Applicant’s flight information or details with booking reference; and
