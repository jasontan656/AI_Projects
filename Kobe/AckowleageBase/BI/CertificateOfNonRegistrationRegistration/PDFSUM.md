...
- 生成时间: 2025-10-24T06:55:49.429791+00:00
- 来源目录: `CertificateOfNonRegistrationRegistration`
## CertificationApplication.pdf
- 路径: `CertificationApplication.pdf`
- 更新: 2025-10-24T05:58:33.896189+00:00

```
BI FORM 2014-08-016 Rev 0
CERTIFICATION OF NON-REGISTRATION/REGISTRATION
...
1.  Letter addressed to the Commissioner, attention the Alien Registration Division (ARD) requesting for
the certification of registration/non-registration and indicating the purpose thereof;
2.  Photocopy of Birth Certificate, if applicable (for Department of Foreign Affairs purposes);
3.  Photocopy of passport page bearing the visa implementation and latest admission with authorized stay,
if applicable; and
4.  Four (4) pieces of 2x2 photograph of the applicant with white background and must be taken within the
