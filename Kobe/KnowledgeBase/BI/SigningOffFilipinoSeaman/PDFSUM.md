...
- 生成时间: 2025-10-24T06:56:14.335966+00:00
- 来源目录: `SigningOffFilipinoSeaman`
## SignOffChecklist.pdf
- 路径: `SignOffChecklist.pdf`
- 更新: 2025-10-24T06:01:20.872542+00:00

```
BI FORM 2014-10-009 Rev 1
FILIPINO SEAFARER (SIGN OFF)
...
FILIPINO SEAFARER (SIGN OFF)
1. Letter addressed to the Commissioner from the shipping or manning agent to allow signing off
of Filipino seafarers, duly received by the Bay Service Section prior to the arrival of the vessel;
2. Derogatory record verification (No Derogatory Stamp);
3. Photocopy of seaman’s book;
4. Photocopy of the bio-page of the seaman’s passport;
5. Photocopy of vessel’s crew list signed by the captain; and
6. Accomplished Immigration arrival card.
