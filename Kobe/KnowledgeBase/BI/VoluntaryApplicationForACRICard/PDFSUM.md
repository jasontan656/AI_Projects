...
- 生成时间: 2025-10-24T06:56:39.330625+00:00
- 来源目录: `VoluntaryApplicationForACRICard`
## ACRApplicationForm.pdf
- 路径: `ACRApplicationForm.pdf`
- 更新: 2025-10-24T05:57:16.730164+00:00
...
Page 2 of 2
```
## VoluntaryApplicationForm.pdf
- 路径: `VoluntaryApplicationForm.pdf`
- 更新: 2025-10-24T05:57:16.662055+00:00

```
BI FORM 2014-08-007 Rev 0
VOLUNTARY APPLICATION FOR ALIEN CERTIFICATE OF
REGISTRATION IDENTITY CARD (ACR I-CARD)
...
3.  If the application is filed by an authorized representative, attach a photocopy of the Bureau of Immigration
...
4.  The  original  valid  passport  of  the  applicant  must  be  presented  to  the  concerned  frontline  officer  for
identification purposes. Thereafter, it shall be returned.
CHECKLIST OF DOCUMENTARY REQUIREMENTS FOR VOLUNTARY APPLICATION FOR
...
1.  Letter  request  addressed  to  the  Commissioner  through  the  Chief  of  the  Alien  Registration  Division
stating the purpose for the application;
2.  Accomplished application form (BI Form 2014-08-006 Rev 0);
3.  Photocopy of  passport  bio-page  and  passport  pages  bearing  the  visa  implementation  page  and  latest
admission with authorized stay;
4.  Photocopy of  Identification  (ID) card from the concerned agency (i.e. PRA, BOI,  PEZA, CEZA, etc.), if
applicable;
5.  Photocopy of Marriage Certificate or Birth Certificate (Balikbayan admission); and
6.  Original paper-based ACR, if applicable.
