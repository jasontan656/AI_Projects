"""
Core envelope schema definitions aligned with WorkPlan 13.

This module exposes the canonical CoreEnvelope model used by adapters,
contracts, and tooling. It intentionally preserves compatibility with legacy
flattened payloads while enforcing the documented nested metadata/payload/
ext_flags structure.
"""
