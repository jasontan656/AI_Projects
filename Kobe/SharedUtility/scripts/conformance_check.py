...
from SharedUtility.core.prompt_registry import PromptRegistry
...
GENERATED_FILES = [
    ...
    REPO_ROOT / "TelegramAPI" / "adapters" / "response.py",
    ...
    REPO_ROOT / "SharedUtility" / "Config" / "runtime_policy.json",
...
def ensure_prompts() -> list[str]:
    try:
        PromptRegistry(REPO_ROOT / "SharedUtility" / "Config")
